...
- **A fabricated formula was found and corrected at the source.** The
  project's code generator originally produced a loss-tangent formula with
  unattributed constants that did not reproduce the cited paper's own
  data. It was replaced with the validated Siegler et al. (2020) form,
  confirmed against that paper's Figure 8 maps to 2–5% median error and
